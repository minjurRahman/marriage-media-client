...
const SingleSummaryData = ({biodata}) => {
    const { MaritalStatus, Birthday, Height, Complexion, Weight, Occupation, _id } = biodata;
    return (
        <div>
            <div className="card bg-base-100 shadow-xl border">
                ...
                <div className="card-body items-center text-center">
                    ...
                    <Link to={``}><button className='btn btn-primary'>Cart</button></Link>
                </div>
            </div>
        </div>
    );
...
export default SingleSummaryData;